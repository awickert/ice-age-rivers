...
#map_titles = ['ICE-5G: 13.5 ka to 13.0 ka difference']
map_titles = ['ICE-6G: 14.5 ka to 14.0 ka']
#units = ['Ice mass balance [m yr$^{-1}$]']
...
fig.tight_layout()
plt.savefig('../figures/dHi_dt.pdf')
#plt.savefig('../figures/dHi_dt.png')
#plt.show()
plt.close()
